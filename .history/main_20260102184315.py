...
def createShortsJob(request):
    ...
    try:
        ...
        if not is_valid:
            ...
            send_notification(db,user_id=user_id,event_type=NotificationEventType.SHORT_FAILED)
        ...
        try:
            ...
            # 2. Check credits using total cost
